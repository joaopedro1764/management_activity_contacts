        ...
        {isOpenSidebar && (
          <button
            ...
            className={`absolute p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-100 rounded-full transition-all duration-200 z-10 ${
              isMobile ? "top-4 right-4" : isCollapsed ? "top-20 left-1/2 transform -translate-x-1/2" : "top-4 right-4"
            }`}
          >
            {isMobile ? (
              <X className="w-5 h-5" />
                        ...
                        <div className="flex-1 overflow-hidden">
                          ...
                          <div
                            className={`text-xs truncate ${
                              isActive ? "text-white/80" : "text-blue-600 group-hover:text-blue-700"
                            }`}
                          >
                            {item.description}
                          </div>
